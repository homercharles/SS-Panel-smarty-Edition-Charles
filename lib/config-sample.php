...
define('DB_HOST','localhost');//数据库连接地址
define('DB_USER','root');//数据库用户名
define('DB_PWD','asswecan');//数据库密码
define('DB_DBNAME','ss-panel');//数据库的库名
define('DB_PORT',3306);//数据库的端口号,一般默认是3306,建议修改为其他不常用的端口号例如:53389,请注意防火墙放过这个端口号
define('DB_CHARSET','utf8');//数据库编码
define('DB_TYPE','mysql'); //数据库类型,一般建议使用MySQL,如果使用mssql或者DB2等,请自行修改程序
/*
 * 下面的东西根据需求修改
 */
